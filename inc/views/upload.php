...
<tr<?php echo $triggable; ?>>
	...
	<td>
		<div style="width:300px">
			...
			<a href="#" rel="<?php echo $option['id']; ?>" class="button alignright sunrise-plugin-upload-button hide-if-no-js" style="width:60px;text-align:center;overflow:hidden;padding-left:0;padding-right:0"><?php _e( 'Upload', 'gpr' ); ?></a>
		</div>
